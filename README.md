...
开源版本在 `opensource` 分支持续维护，关联 `origin/opensource`。已接入 ProjectHub 的“工百窗 · 开源单机版”，可查看分支、选择文件提交、获取远端更新及推送维护分支。日常提交与同步方式见 [仓库维护流程](maintenance/repository-workflow.md)。深耕版工作区继续独立维护。
