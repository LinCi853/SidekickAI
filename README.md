...
开源版是深耕版在本地独立维护的提前分发版本，在 GitHub 直接作为主项目维护 `main`。已接入 ProjectHub 的“工百窗 · 开源单机版”，可选择文件提交、获取远端更新及直接更新主项目。日常提交与同步方式见 [仓库维护流程](maintenance/repository-workflow.md)。深耕版工作区继续独立维护。
